...
from api.namespaces import model_builder_namespace as api
...
builder_fields = api.model('Builder', {
    ...
    'modelType': fields.String(default='MOJO', required=False,
                               description='Build POJO or MOJO model.  Default is MOJO.',
                               enum=['H2O', 'POJO'])
})
